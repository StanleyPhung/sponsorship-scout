...
import { Video, Sparkles, TrendingUp, Clock, Eye } from "lucide-react";
  ...
  const videoIdeas = [
    {
      ...
      description: "Show the trending butter-sizzle technique with cinematic close-ups",
      category: "Food Trend",
    ...
    },
    {
      ...
      description: "Partner with organization brand to showcase classroom systems",
    ...
    <Card className="p-6 shadow-soft bg-gradient-card">
      ...
      <div className="grid gap-4">
        {videoIdeas.map((video, index) => (
          <Card key={video.id} className="p-4 bg-background border-2 hover:border-primary/30 transition-all duration-300 hover:shadow-soft">
            <div className="flex items-start justify-between mb-3">
              <div className="flex-1">
                ...
                <p className="text-primary font-medium text-sm mb-2">"{video.hook}"</p>
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground">
              Videos marked "Brand Ready" are perfect for showcasing to potential sponsors
            </p>
          </div>
        </div>
      </div>
